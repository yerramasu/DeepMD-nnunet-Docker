...
@app.route('/thoractic/predict', methods=['GET'])
def upload_form():
...
@app.route('/thoractic/predict', methods=['POST'])
def upload():
    ...
    if request.method == 'POST':
        ...
        subprocess.check_output("/home/predict.sh", shell=True)
        return redirect('/thoractic/predict')

@app.route('/thoractic/prediction', methods=['POST'])
def prediction():
    if request.method == 'POST':
        ...
        subprocess.check_output("/home/predict.sh", shell=True)
        return redirect('/thoractic/test')
